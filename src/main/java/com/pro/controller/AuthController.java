...
import com.pro.config.JwtProvider;
...
import com.pro.response.AuthResponse;
import com.pro.service.CartService;
import com.pro.service.CustomUserDetails;
...
public class AuthController {
	...
	public AuthController(UserRepository userRepository, PasswordEncoder passwordEncoder,
			JwtProvider jwtProvider, CustomUserDetails customUserDetails, CartService cartService) {
	...
	public ResponseEntity<AuthResponse> createUserHandler(@Valid @RequestBody User user) throws UserException {
		...
		// Ensure the user ID is available -- temprory
